...
public class StringEncrypter {
    ...
    public static String encriptarPass(String pass, String pk) {
        StringEncrypter desEncrypter = new StringEncrypter(pk);
        String desEncrypted = desEncrypter.encrypt(pass);
        return desEncrypted;
    }
